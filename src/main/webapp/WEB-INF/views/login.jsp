	...
	<div class="container login-container">
		<div class="card">
			...
			<c:if test="${not empty loginEmployee}">
				<h4 class="mb-4 text-center">${loginEmployee.employeeName}님,
					환영합니다!
					(${loginEmployee.employeeLevel})</h4>
        ...
        onclick="alert('해당 권한으로는 기안 작성이 불가능합니다.'); return false;"
						...
						작성</a> <a href="/docList" class="btn btn-secondary w-100">기안 리스트</a> <a
						href="logout" class="btn btn-danger w-100">로그아웃</a>
				</div>
			</c:if>
			...
			<c:if test="${empty loginEmployee}">
				...
				<form action="login" method="post">
					<div class="mb-3">
						<label for="employeeId" class="form-label">ID</label> <input
							type="text" class="form-control" id="employeeId"
							name="employeeId" required>
					</div>
					<div class="mb-3">
						<label for="employeePw" class="form-label">비밀번호</label> <input
							type="password" class="form-control" id="employeePw"
							name="employeePw" required>
					</div>
